<template>
  <div class="h_header" style="list-style: none">
    <div class="h_nav_fixed">
      <div class="h_nav">
        <div class="h_logo">

        </div>
        <ul v-show="navList" class="h_nav_ul clearfix" style="list-style: none;float: left">
<!--          <li v-for="(item, index) in navList" :key="index" style="list-style: none">-->
<!--            <a :class="{active: isNow === item.navUrl}" :href="item.navUrl" :target="item.target">{{item.navTitle }}</a>-->
<!--          </li>-->
          <li>
            <el-button type="primary" round @click="routermain()">首页</el-button>
          </li>
          <li>
            <el-button type="primary" round @click="routerrecommend()">推荐</el-button>
          </li>
          <li>
            <span @click="routerhelp()" style="cursor: pointer"> &nbsp; &nbsp;帮助 &nbsp; &nbsp;</span>
          </li>
        </ul>
        <div v-show="!hideTop" class="search_box clearfix">
          <div class="clearfix">
            ...
            <input v-model="search" type="text" class="search_input" placeholder="该功能暂不可用"
...
export default {
  ...
  data() {
    return {
      ...
      userInfo: '',
      websiteInfo: {
        "websiteDomain": "https://www.sqchenle.top/",
        "websiteName": "领课教育系统",
